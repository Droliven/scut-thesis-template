...
\begin{document}
	...
	\include{chapters/abstract.tex} % 中英文摘要
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\include{chapters/symbols.tex}	% 符号对照表(可选)
	\include{chapters/abbreviation.tex} 	% 缩略词	
	...
	\include{chapters/chapter01.tex}%第一章
	\include{chapters/chapter02.tex}%第二章
	\include{chapters/chapter03.tex}%第三章
...
% 	\include{appendix}
 	% 有多个附录
	% \include{chapters/appendix1.tex} %附录1
	% \include{chapters/appendix2.tex} %附录2
 	%%%%%%%%%%%%%%%%%%%
	 \include{chapters/pub.tex} %终稿成果表
	 % \include{chapters/pub_db.tex} %盲审成果表
	\include{chapters/ack.tex} %致谢
\end{document}
